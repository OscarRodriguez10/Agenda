            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div>
                        ...
                        <input v-model="contact.phone" type="text" class="form-control" id="fphone" placeholder="Telefonos" name="">
                    </div>
                     <div>
                        <label for="addess">Domicilio</label>
